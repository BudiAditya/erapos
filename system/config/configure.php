...
// Folder are calculated based on evaluasi_web.php script location (Adding support if bootstrap filename changed)
// Ex : /xxx/yyy/zzz/add1.php -> we must get rid of first '/' and '/add1.php'
if (!defined("FOLDER")) {
	$scriptName = $_SERVER["SCRIPT_NAME"];
	$tokens = explode("/", $scriptName);

	// Remove the filename ('evaluasi_web.php' or other name)
