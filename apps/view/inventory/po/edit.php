...
<script>
    ...
    $(document).on("click",".btdRemove",function(){
        ...
        var urd = "<?php print($helper->site_url("inventory/po/deldetail"));?>";
        swal({
                ...
                $.ajax({
                    ...
                    success: function(dtz, textStatus, jqXHR)
                    {
                        ...
                        if(data.result == 1){
                            ...
                            var urs = "<?php print($helper->site_url("inventory/po/getSubTotal/"));?>" + po_no;
    ...
    $(document).on("click","#btSvDetail",function(){
        ...
        var sku = $('#txtSku').val();
        var qty = $('#txtQty').val();
        var urm = "<?php print($helper->site_url("inventory/po/addmaster"));?>";
        var urd = "<?php print($helper->site_url("inventory/po/addetail"));?>";
        var oke = 1;
