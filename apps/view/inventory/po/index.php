...
<head>
    ...
    <title>EraPOS | Daftar Pesanan Bahan </title>
                ...
                <div class="clearfix"></div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <p>
                                    <button type="submit" class="btn btn-primary btn-sm" id="btAdd" name="btAdd"><i class="fa fa-plus"></i> PEMESANAN BAHAN</button>
                                </p>
...
<script>
    $(document).ready( function ()
    {
        ...
        $('#tablePos').DataTable({
            ...
            "pageLength": 10,
            "ajax": {
                "url": "<?php print($helper->site_url("inventory/po/getJsonPo"));?>",
                "type": "POST"
            },
            "columns": [
                { "data": "urutan" },
    ...
    $('#btAdd').click(function (e) {
        ...
        var urx = "<?php print($helper->site_url("inventory/po/add"));?>";
        if (oid == 0){
    ...
    $(document).on("click",".btsEdit",function(){
        ...
        var po_status = $(this).attr("po_status");
        var urz = "<?php print($helper->site_url("inventory/po/edit/"));?>"+po_no;
        if (po_status == 0){
            location.href = urz;
        }else{
    ...
    $(document).on("click",".btsView",function(){
        var po_no = $(this).attr("po_no");
        var po_status = $(this).attr("po_status");
        var urz = "<?php print($helper->site_url("inventory/po/view/"));?>"+po_no;
        location.href = urz;
    });
    ...
    $(document).on( "click",".btsDelete", function() {
        ...
        if (po_status == 0) {
            swal({
                    title: "Hapus Data Pesanan Bahan",
                    text: "Nomor: " + po_no + " ?",
                    type: "warning",
