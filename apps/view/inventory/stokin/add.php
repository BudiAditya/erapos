            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><div id="frmTitle">PILIH BAHAN YANG DITERIMA</div></h4>
                    </div>
                    <!--modal header-->
...
<script>
    ...
    $(document).on("click",".btdRemove",function(){
        ...
        var urd = "<?php print($helper->site_url("inventory/stokin/deldetail"));?>";
        swal({
                ...
                $.ajax({
                    ...
                    success: function(dtz, textStatus, jqXHR)
                    {
                        ...
                        if(data.result == 1){
                            ...
                            var urs = "<?php print($helper->site_url("inventory/stokin/getSubTotal/"));?>" + stokin_no;
    ...
    $(document).on("click","#btSvDetail",function(){
        ...
        var sku = $('#txtSku').val();
        var qty = $('#txtQty').val();
        var urm = "<?php print($helper->site_url("inventory/stokin/addmaster"));?>";
        var urd = "<?php print($helper->site_url("inventory/stokin/addetail"));?>";
        var oke = 1;
