            ...
            <div class="">
                <div class="clearfix"></div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>LAPORAN PENERIMAAN PIUTANG</h2>
                            ...
                            <div class="x_content">
                              <div class="table-responsive">
                                  <form id="frm" action="<?php print($helper->site_url("trx.receive/report")); ?>" method="post">
                                        ...
                                        <tr>
                                            <td><select class="form-control" id="outletId" name="outletId" >
                                                    ...
                                                    foreach ($outlets as $outlet) {
                                                        if ($outlet->Kode == $outletId) {
                                                            printf('<option value="%s" selected="selected">%s</option>', $outlet->Kode, $outlet->Kode);
                                                        } else {
                                                            printf('<option value="%s">%s</option>', $outlet->Kode, $outlet->Kode);
                                                        }
                                                    }
                                                    ?>
                                                </select>
                                  ...
                                  <table id="tableReport" class="table table-bordered table-condensed">
                                      ...
                                      if ($reports != null) {
                                          ...
                                          foreach ($reports as $trxsale) {
                                              ...
                                              printf('<td>%s</td>', $trxsale->ReffNo);
                                              printf('<td>%s</td>', $trxsale->CustCode);
                                              printf('<td align="right">%s</td>', number_format($trxsale->Jumlah));
                                              print('</tr>');
                                              $total+= $trxsale->Jumlah;
                                          }
                                          print('</tbody>');
                                      }
                                      ?>
