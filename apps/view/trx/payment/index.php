...
<head>
    ...
    <title>EraPOS | Pembayaran Hutang </title>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <table id="tablePayment" class="table table-striped table-bordered table-hover">
                                    <thead>
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><div id="frmTitle">Transaksi Pembayaran Hutang</div></h4>
                    </div>
                    <!--modal header-->
                    <div class="modal-body">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label for="cboSuppCode" class="col-sm-3  control-label">Nama Supplier</label>
                                <div class="col-sm-9">
                                    <div id="cbSupplier">
                                        <select class="form-control" name="cboSuppCode" id="cboSuppCode" required>
                            ...
                            <div class="form-group">
                                <label for="cboReffNo" class="col-sm-3  control-label">No.Trx Tagihan</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label for="txtJumlah" class="col-sm-3  control-label">Jumlah Bayar</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="txtJumlah" placeholder="Jumlah Bayar" value="0" style="text-align: right" required>
                                </div>
                            </div>
                            <div class="form-group">
...
<script>
    ...
    $(document).ready( function ()
    {
        ...
        $('#tablePayment').DataTable({
            ...
            "pageLength": 10,
            "ajax": {
                "url": "<?php print($helper->site_url("trx/payment/getJsonPayment"));?>",
                "type": "POST"
            },
            "columns": [
                { "data": "urutan" },
    ...
    //suppcode change
    $(document).on('change', "#cboSuppCode", function(){
        var spc = $(this).val();
        initCbOutstanding(spc);
    });
        ...
        if (ptrxmode == 1) {
            swal({
                ...
                function () {
                    ...
                    $.ajax(
                        {
                            url: "<?php print($helper->site_url("trx/payment/delete"));?>",
                            type: "POST",
                            data: idvalue,
    ...
    $(document).on("click","#btSave",function(){
        ...
        if (tsuppcode == '0' || tsuppcode == null ){
            swal("Warning","Nama Supplier harus dipilih!","warning");
            $("#cboSuppCode").focus();
            return;
        }
        ...
        if (crud == 'N'){
            urx = "<?php print($helper->site_url("trx/payment/add"));?>";
        }else if (crud == 'E'){
            urx = "<?php print($helper->site_url("trx/payment/edit"));?>"
        }
        var dvalue = {
            Id: tid,
            TrxDate: ttrxdate,
    ...
    function initCbSupplier() {
        var urx = "<?php print($helper->site_url("trx/payment/getSupplierByOutletId"));?>";
        $("#cbSupplier").html('');
    ...
    function initCbOutstanding(supcode) {
        var urx = "<?php print($helper->site_url("trx/payment/getOutstandingBySuppCode/"));?>"+supcode;
        if (supcode.length > 0) {
            $("#cbOutstanding").html('');
            $.get(urx, function (dtx) {
