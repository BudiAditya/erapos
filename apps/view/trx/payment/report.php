...
<head>
    ...
    <title>EraPOS | Laporan Pembayaran Hutang </title>
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                              <div class="table-responsive">
                                  <form id="frm" action="<?php print($helper->site_url("trx.payment/report")); ?>" method="post">
                              ...
                              <div class="table-responsive">
                                  <table id="tableReport" class="table table-bordered table-condensed">
                                      ...
                                      if ($reports != null) {
                                          ...
                                          /** @var $reports Payment[] */
                                          $nmr = 0;
                                          foreach ($reports as $payment) {
                                              $nmr++;
                                              print('<tr>');
                                              printf('<td>%d</td>', $nmr);
                                              printf('<td>%s</td>', $payment->OutletKode);
                                              printf('<td>%s</td>', $payment->TrxNo);
                                              printf('<td>%s</td>', $payment->TrxDate);
                                              printf('<td>%s</td>', $payment->SuppCode);
                                              printf('<td>%s</td>', $payment->ReffNo);
                                              printf('<td align="right">%s</td>', number_format($payment->Jumlah));
                                              if ($payment->TrxStatus == 1) {
                                                  print('<td>Draft</td>');
                                              }elseif ($payment->TrxStatus == 2){
                                                  print('<td>Close</td>');
                                              }else{
                                                  print('<td>Void</td>');
                                              }
