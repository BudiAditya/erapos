...
<script>
    $(document).ready( function ()
    {
        ...
        $('#tablePos').DataTable({
            ...
            "pageLength": 10,
            "ajax": {
                "url": "<?php print($helper->site_url("trx/salesorder/getJsonPo"));?>",
                "type": "POST"
            },
            "columns": [
                { "data": "urutan" },
    ...
    $(document).on("click",".btsEdit",function(){
        ...
        var urz = "<?php print($helper->site_url("trx/salesorder/edit/"));?>"+po_no;
        if (po_status == 0){
            location.href = urz;
        }else{
    ...
    $(document).on("click",".btsView",function(){
        var po_no = $(this).attr("po_no");
        var po_status = $(this).attr("po_status");
        var urz = "<?php print($helper->site_url("trx/salesorder/view/"));?>"+po_no;
        location.href = urz;
    });
