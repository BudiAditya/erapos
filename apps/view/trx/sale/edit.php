                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <form id="frm" class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" class="form-control num" id="txtSubTotal" placeholder="Sub Total" name="SubTotal" value="<?php print($sale->SubTotal);?>" readonly style="text-align: right;font-size: 20px;">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="txtDiscPct" class="col-md-6 col-sm-6 col-xs-12 control-label">DISKON %</label>
                                            <div class="col-md-2 col-sm-2 col-xs-6">
                                                <input type="text" class="form-control num" id="txtDiscPct" name="DiscPct" value="<?php print($sale->DiscPct);?>" style="text-align: right;font-size: 20px;">
                                            </div>
                                            <div class="col-md-4 col-sm-4 col-xs-6">
                                                <input type="text" class="form-control num" id="txtDiscAmt" name="DiscAmt" value="<?php print($sale->DiscAmt);?>" readonly style="text-align: right;font-size: 20px;">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-6">
                                                ...
                                                <input type="hidden" id="txtTaxPct" name="TaxPct" value="<?php print($sale->TaxPct);?>">
                                            </div>
                                            <div class="col-md-4 col-sm-4 col-xs-6">
                                                <input type="text" class="form-control num" id="txtTaxAmt" name="TaxAmt" value="<?php print($sale->TaxAmt);?>" readonly style="text-align: right;font-size: 20px;">
                                            </div>
                                        </div>
                                        <div class="separator"></div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <b>
                                                    <input type="text" class="form-control num" id="txtTotal" placeholder="Sub Total" name="GrandTotal" value="<?php print($sale->PayAmt);?>" readonly style="text-align: right;font-size: 20px;">
                                                </b>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<script>
    $(document).ready( function ()
    {
        ...
        var ulevel = Number('<?php print($userLvl);?>');
        //init data first
        InitData();
    ...
    function InitData() {
        var trx_no = '<?php print($sale->TrxNo);?>';
        var is_tax = '<?php print($sale->IsTaxable);?>';
        if (is_tax == '1'){
            $("#isTaxable").prop('checked', true);
        }else{
            $("#isTaxable").prop('checked', false);
        }
        var uri = "<?php print($helper->site_url("trx/sale/getSubTotal/"));?>"+trx_no;
